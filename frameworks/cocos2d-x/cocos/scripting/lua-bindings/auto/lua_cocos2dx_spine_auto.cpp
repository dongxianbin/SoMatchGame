...
int lua_cocos2dx_spine_SkeletonRenderer_addBind(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonRenderer* cobj = nullptr;
    bool ok = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonRenderer_addBind'", nullptr);
        return 0;
    }
#endif
    argc = lua_gettop(tolua_S) - 1;
    do{
        if (argc == 2) {
            Node* arg0;
            const char *arg1;
            ok &= luaval_to_object<cocos2d::Node>(tolua_S, 2, "cc.Node", &arg0, "sp.SkeletonRenderer:addBind");
            if (!ok) { tolua_error(tolua_S, "invalid arguments node in function 'lua_cocos2dx_sp_SkeletonRenderer_addBind'", nullptr); return 0; }
            std::string arg1_tmp; ok &= luaval_to_std_string(tolua_S, 3, &arg1_tmp, "sp.SkeletonRenderer:addBind"); arg1 = arg1_tmp.c_str();
            if (!ok) { tolua_error(tolua_S, "invalid arguments string in function 'lua_cocos2dx_sp_SkeletonRenderer_addBind'", nullptr);  return 0; }
            bool ret = cobj->addBind(arg0, arg1);
            tolua_pushboolean(tolua_S, (bool)ret);
            return 1;
        }
    } while (0);
    ok = true;
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonRenderer:addBind", argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_spine_SkeletonRenderer_addBind'.", &tolua_err);
#endif

    return 0;
}

int lua_cocos2dx_spine_SkeletonRenderer_delBind(lua_State* tolua_S)
{
    int argc = 0;
    spine::SkeletonRenderer* cobj = nullptr;
    bool ok = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S, "invalid 'cobj' in function 'lua_cocos2dx_spine_SkeletonRenderer_delBind'", nullptr);
        return 0;
    }
#endif
    argc = lua_gettop(tolua_S) - 1;
    do{
        if (argc == 1) {
            Node* arg0;
            ok &= luaval_to_object<cocos2d::Node>(tolua_S, 2, "cc.Node", &arg0, "sp.SkeletonRenderer:delBind");
            if (!ok) { tolua_error(tolua_S, "invalid arguments node in function 'lua_cocos2dx_spine_SkeletonRenderer_delBind'", nullptr); return 0; }
            cobj->delBind(arg0);
            return 1;
        }
    } while (0);
    ok = true;
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "sp.SkeletonRenderer:delBind", argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
tolua_lerror:
    tolua_error(tolua_S, "#ferror in function 'lua_cocos2dx_spine_SkeletonRenderer_delBind'.", &tolua_err);
#endif
    return 0;
}
...
int lua_register_cocos2dx_spine_SkeletonRenderer(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"SkeletonRenderer");
        ...
        tolua_function(tolua_S, "addBind", lua_cocos2dx_spine_SkeletonRenderer_addBind);
        tolua_function(tolua_S, "delBind", lua_cocos2dx_spine_SkeletonRenderer_delBind);
